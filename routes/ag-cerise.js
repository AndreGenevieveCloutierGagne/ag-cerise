...
db = new Db('ag-ceriseDB', server, {safe: true});


db.open(function(err, db) {
    if(!err) {
        console.log("Connected to 'ag-ceriseDB' database");
        db.collection('ag-cerise', {safe:true}, function(err, collection) {
            if (err) {
                console.log("The 'ag-ceriseDB' collection doesn't exist. Creating it with sample data...");
               ///// populateDB();
            }
        });
    }
...
exports.findById = function(req, res) {
    ...
    console.log('Retrieving cerise: ' + id);
    db.collection('ag-cerise', function(err, collection) {
...
var populateDB = function() {
    ...
    db.collection('ag-cerise', function(err, collection) {
        collection.insert(ag_cerise, {safe:true}, function(err, result) {});
    });
